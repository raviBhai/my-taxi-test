...
VALUES
(1, TRUE, now(), FALSE, 'ELECTRIC', 'mh1', 'vw', 2.0, 2);

insert into car (ID, CONVERTIBLE, DATE_CREATED, DELETED, ENGINE_TYPE, LICENSE_PLATE, MANUFACTURER, RATING, SEAT_COUNT)
VALUES
(2, TRUE, now(), FALSE, 'GAS', 'mh2', 'bmw', 1.0, 2);

insert into car (ID, CONVERTIBLE, DATE_CREATED, DELETED, ENGINE_TYPE, LICENSE_PLATE, MANUFACTURER, RATING, SEAT_COUNT)
VALUES
(3, TRUE, now(), FALSE, 'ELECTRIC', 'mh3', 'vw', 1.0, 4);

insert into car (ID, CONVERTIBLE, DATE_CREATED, DELETED, ENGINE_TYPE, LICENSE_PLATE, MANUFACTURER, RATING, SEAT_COUNT)
VALUES
(4, TRUE, now(), FALSE, 'GAS', 'mh4', 'bmw', 3.0, 2);

insert into car (ID, CONVERTIBLE, DATE_CREATED, DELETED, ENGINE_TYPE, LICENSE_PLATE, MANUFACTURER, RATING, SEAT_COUNT)
VALUES
(5, TRUE, now(), FALSE, 'ELECTRIC', 'mh5', 'vw', 1.0, 6)
;

insert into DRIVER_WITH_CAR (DRIVER_ID,  	CAR_ID)
VALUES
(4,	3),
(5,	1)
;
